...
public class CtrlProduct {
	...
	public ResponseEntity<List<DtoProductList>> getProductList(@PathVariable("category_id") Integer category_id){
		return new ResponseEntity<>(svc.getProductCategoryId(category_id),HttpStatus.OK);
	}
