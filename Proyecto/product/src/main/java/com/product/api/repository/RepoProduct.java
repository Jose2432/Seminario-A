...
public interface RepoProduct extends JpaRepository<Product, Integer>
{
	...
	@Modifying
	@Transactional
	@Query(value ="UPDATE product SET status = 1 WHERE gtin = :gtin AND product = :product", nativeQuery = true)
	Integer activateProduct(@Param("gtin") String gtin, @Param("product") String product);
