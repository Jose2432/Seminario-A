...
public interface ProductClient {
	...
	@GetMapping("product/{gtin}")
	public DtoProduct getProductDto(@PathVariable("gtin") String gtin);
	...
	@PutMapping("product/{gtin}/stock/{stock}")
	public void updateProductStock1(@PathVariable("gtin") String gtin, @PathVariable("stock") Integer stock);
}
