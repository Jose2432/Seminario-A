...
public class Item {
	...
	public Item(Integer item_id, Integer id_invoice,String gtin,Integer quantity,Double unit_price,Double subtotal,Double taxes,Double total,Integer status)
	{
		super();
